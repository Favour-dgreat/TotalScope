...
>
  {/* Left Side Content */}
  <div className={`${style.left} w-full md:w-1/2 text-center md:text-left mt-10 `}>
    ...
    <Link
      ...
      className={`${style.hireBtn} inline-block text-white px-4 py-4 font-semibold text-sm md:text-base shadow-lg hover:scale-105 transition-transform duration-300`}
    >
      Hire Us
    </Link>
  </div>
